...
const NewCheckFungible: BlitzPage = () => {
...
NewCheckFungible.suppressFirstRenderFlicker = true
NewCheckFungible.getLayout = function getLayout(page) {
...
export default NewCheckFungible
