...
// import { TerminalMetadata } from "app/v1/terminal/types"
...
//               <p className="text-marble-white text-base">Be the first to endorse this applicant!</p>
//             ) : (
...
export const ApplicantDetailsModal = () => <div></div>
