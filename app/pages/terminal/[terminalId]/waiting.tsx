...
const TerminalWaitingPage: BlitzPage = () => {
  ...
  let [selectedApplicantToView, setselectedApplicantToView] = useState<Account | null>(null)
      ...
      {!initiatives || !initiatives.length ? (
        ...
        <div>
          <ApplicantDetailsModal
            applicant={selectedApplicantToView}
          ...
          <div className="flex flex-col space-y-10">
            ...
            <div className="flex-auto text-marble-white">
              {!dummyData || !dummyData.length ? (
                ...
                // </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4" onClick={() => {}}>
                  {dummyData.map((application, index) => (
                    <ContributorCard
                      key={index}
                      contributor={application as Account}
                      endorse={endorseAbility}
                      accepted={accepted}
                      openApplicantModal={openApplicantModal}
                      setselectedApplicantToView={setselectedApplicantToView}
