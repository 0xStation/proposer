...
const TerminalInitiativeCreatePage: BlitzPage = () => {
  ...
  return (
    <Layout title={`${terminal?.data?.name ? terminal?.data?.name + " | " : ""}Create Initiative`}>
      {!userCanEdit ? (
        ...
        <div className="bg-tunnel-black min-h-[calc(100vh-15rem)] h-[1px] relative">
          ...
          <h1 className="text-marble-white text-4xl text-center pt-12">Create Initiative</h1>
...
TerminalInitiativeCreatePage.suppressFirstRenderFlicker = true

export default TerminalInitiativeCreatePage
