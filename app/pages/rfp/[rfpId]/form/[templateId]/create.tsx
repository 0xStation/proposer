...
const RfpTemplateCreateForm: BlitzPage = () => {
  ...
  return (
    <Layout title="New Proposal">
      ...
      <div className="flex flex-row h-full">
        ...
        {templateIdToForm[rfp?.templateId as string] || <FoxesProposalForm />}
      </div>
    </Layout>
  )
}

RfpTemplateCreateForm.suppressFirstRenderFlicker = true

export default RfpTemplateCreateForm
