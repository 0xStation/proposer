    ...
    <Layout title="New Proposal">
      <div className="mx-2 sm:mx-28 h-full">
        ...
        <div className="pt-4 mx-4 flex flex-col sm:flex-row">
          <div
            tabIndex={0}
            className="max-w-[325px] mb-3 sm:mr-3 rounded-md overflow-hidden bg-wet-concrete cursor-pointer hover:border hover:border-marble-white"
          >
          ...
          <div
            tabIndex={0}
            className="max-w-[325px] mb-3 sm:mr-3 rounded-md overflow-hidden bg-wet-concrete cursor-not-allowed"
          >
